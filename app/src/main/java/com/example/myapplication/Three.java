...
public class Three extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tV1:
                Intent intent1=new Intent(Three.this,One.class);
                startActivity(intent1);
                this.finish();
                it();
                break;
            case R.id.tV2:
                Intent intent2=new Intent(Three.this,Two.class);
                startActivity(intent2);
                it();
                this.finish();
                break;
            case R.id.tV3:
                Intent intent3=new Intent(Three.this,MainActivity.class);
                startActivity(intent3);
                it();
                this.finish();
                break;
            case R.id.tV4:
                Intent intent4=new Intent(Three.this,Four.class);
                startActivity(intent4);
                it();
                this.finish();
                break;
            case R.id.tV5:
                Intent intent5=new Intent(Three.this,Five.class);
